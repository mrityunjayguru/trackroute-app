        ...
        children: [
            ...
            Obx(
              () => Flexible(
                child: SingleChildScrollView(
                  ...
                  future: (controller.deviceDetail.value?.trackingData?.location
                                  ?.latitude !=
                              null &&
                  ...
                  builder: (context, snapshot) {
                    ...
                    Data vehicleInfo = controller.deviceDetail.value ?? Data();
                    TrackingData? trackingData = vehicleInfo.trackingData;
                    String date = 'Update unavailable';
                    String time = "";
                    if (vehicleInfo.trackingData?.lastUpdateTime?.isNotEmpty ??
                        false) {
                      date =
                      date =
            ...
            Obx(() {
              ...
              return InkWell(
                onTap: () {
                if (isActive &&
                    (controller.deviceDetail.value?.mobileNo?.isNotEmpty ??
                        false)) {
                  Utils.makePhoneCall(
