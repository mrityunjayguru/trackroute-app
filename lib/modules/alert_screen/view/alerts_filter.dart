...
class AlertsFilterPage extends StatelessWidget {
            ...
            children: [
              ...
              StaggeredGrid.count(
                ...
                children: controller.alertsList
                  ...
                  child: alertItem(true, item, context,(){},),
                ))
                    .toList(),
              ),
              SizedBox(height: 2.h),
  ...
  Widget alertItem(bool isSelected, String label, BuildContext context, VoidCallback onTap){
    return InkWell(
      onTap: onTap,
      child: Container(
        ...
        child: Row(
          ...
          children: [
            SvgPicture.asset((isSelected) ? "assets/images/svg/blue_check_icon.svg":"assets/images/svg/grey_check_icon.svg")
